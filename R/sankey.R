...
dat <- fread('/home/sukhyun/dataset/campus/Placement_Data_Full_Class.csv')
...
json_data$data[[1]]$link %>% as.data.table()
json_data$data[[1]]$node$label
